...
typedef SWIFT_ENUM(NSInteger, AiylCameraSelector, open) {
  AiylCameraSelectorFront = 0,
  AiylCameraSelectorBack = 1,
};
...
+ (UINavigationController * _Nonnull)buildViewControllerWithConfig:(AiylConfig * _Nonnull)config withDelegate:(id <AiylClientDelegate> _Nonnull)delegate showCancelButton:(BOOL)showCancelButton shouldDismiss:(BOOL)shouldDismiss SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@protocol AiylClientDelegate
- (void)onCompletedWithResult:(AiylResult * _Nonnull)result;
- (void)onFailedWithException:(AiylException * _Nonnull)exception;
- (void)onCanceled;
@end
...
@property (nonatomic) enum AiylCameraSelector cameraSelector;
...
@property (nonatomic, strong) AiylPreviewSettings * _Nonnull previewSettings;
...
@property (nonatomic) BOOL withCountdown;
@property (nonatomic) NSInteger timeout;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, AiylEntryMode, open) {
  AiylEntryModeFullIdent = 0,
  AiylEntryModeSelfieAndDocument = 1,
  AiylEntryModeSelfieWithDocument = 2,
  AiylEntryModePassportOnly = 3,
  AiylEntryModeSelfieOnly = 4,
};
...
SWIFT_CLASS("_TtC4Aiyl18AiylPassportResult")
@interface AiylPassportResult : NSObject
@property (nonatomic, copy) NSString * _Nonnull front;
@property (nonatomic, copy) NSString * _Nonnull back;
@property (nonatomic) double match;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Aiyl19AiylPreviewSettings")
@interface AiylPreviewSettings : NSObject
...
@property (nonatomic, strong) AiylPassportResult * _Nonnull tin;
@property (nonatomic, strong) AiylPassportResult * _Nonnull passport;
